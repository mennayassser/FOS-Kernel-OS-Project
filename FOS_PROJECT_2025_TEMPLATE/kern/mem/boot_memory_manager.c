...
void initialize_kernel_VM()
{
	...
	// to cprresponding physical address : "phys_stack_bottom + CPUIdx * KERNEL_STACK_SIZE".
	...
	uint32 reverse_map_size = number_of_frames * sizeof(uint32);
	reverse_page_table = boot_allocate_space(reverse_map_size, PAGE_SIZE);
